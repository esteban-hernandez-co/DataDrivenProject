...
namespace Model {
    ...
    public partial class UserDataSet : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public userRow AdduserRow(string username, string name, string lastname, System.DateTime dob, string password, string email, System.DateTime created_at) {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[user] WHERE (([id] = @Original_id) AND ([username] = @Original" +
                "_username) AND ([name] = @Original_name) AND ([lastname] = @Original_lastname) A" +
                "ND ([dob] = @Original_dob) AND ([created_at] = @Original_created_at))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[user] ([username], [name], [lastname], [dob], [password], [email], [created_at]) VALUES (@username, @name, @lastname, @dob, @password, @email, @created_at);
SELECT id, username, name, lastname, dob, password, email, created_at FROM [user] WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[user] SET [username] = @username, [name] = @name, [lastname] = @lastname, [dob] = @dob, [password] = @password, [email] = @email, [created_at] = @created_at WHERE (([id] = @Original_id) AND ([username] = @Original_username) AND ([name] = @Original_name) AND ([lastname] = @Original_lastname) AND ([dob] = @Original_dob) AND ([created_at] = @Original_created_at));
SELECT id, username, name, lastname, dob, password, email, created_at FROM [user] WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, username, name, lastname, dob, password, email, created_at FROM dbo.[u" +
                "ser]";
            ...
            this._commandCollection[2].CommandText = "SELECT id, username, name, lastname, dob, password, email, created_at FROM dbo.[u" +
                "ser]\r\nORDER BY lastname, name";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "SELECT        id, username, name, lastname, dob, password, email, created_at\r\nFRO" +
                "M            [user]\r\nWHERE        (id = @userId)";
            ...
            this._commandCollection[4].CommandText = "SELECT        id, username, name, lastname, dob, password, email, created_at\r\nFRO" +
            ...
            this._commandCollection[5].CommandText = "SELECT        id, username, name, lastname, dob, password, email, created_at\r\nFRO" +
                "M            [user] AS WH\r\nWHERE        (username = @username) AND (password LIK" +
                "E @password)";
            ...
            this._commandCollection[5].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@password", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "password", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[6] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[6].Connection = this.Connection;
            this._commandCollection[6].CommandText = @"INSERT INTO [dbo].[user] ([username], [name], [lastname], [dob], [password], [email]) VALUES (@username, @name, @lastname, @dob, @password, @email);
SELECT id, username, name, lastname, dob, password, email, created_at FROM [user] WHERE (id = SCOPE_IDENTITY())";
            ...
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.NVarChar, 60, global::System.Data.ParameterDirection.Input, 0, 0, "name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@lastname", global::System.Data.SqlDbType.NVarChar, 60, global::System.Data.ParameterDirection.Input, 0, 0, "lastname", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@password", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "password", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@email", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "email", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[7] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[7].Connection = this.Connection;
            this._commandCollection[7].CommandText = "UPDATE [dbo].[user] SET [username] = @username, [name] = @name, [lastname] = @las" +
                "tname, [dob] = @dob,  [email] = @email WHERE (([id] = @Original_id));\r\nSELECT id" +
                ", username, name, lastname, dob, password, email, created_at FROM [user] WHERE (" +
                "id = @id)";
            ...
            this._commandCollection[7].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.NVarChar, 60, global::System.Data.ParameterDirection.Input, 0, 0, "name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[7].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@lastname", global::System.Data.SqlDbType.NVarChar, 60, global::System.Data.ParameterDirection.Input, 0, 0, "lastname", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[7].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@dob", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "dob", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[7].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@email", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "email", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual UserDataSet.userDataTable GetAllUsers() {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual UserDataSet.userDataTable GetUserByUserId(int userId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual UserDataSet.userDataTable GetUserByUsernameAndPassword(string username, string password) {
        ...
        public virtual int Delete(int Original_id, string Original_username, string Original_name, string Original_lastname, System.DateTime Original_dob, System.DateTime Original_created_at) {
        ...
        public virtual int Insert(string username, string name, string lastname, System.DateTime dob, string password, string email, System.DateTime created_at) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        public virtual int Update(string username, string name, string lastname, System.DateTime dob, string password, string email, System.DateTime created_at, int Original_id, string Original_username, string Original_name, string Original_lastname, System.DateTime Original_dob, System.DateTime Original_created_at, int id) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string name, string lastname, System.DateTime dob, string password, string email, System.DateTime created_at, int Original_id, string Original_username, string Original_name, string Original_lastname, System.DateTime Original_dob, System.DateTime Original_created_at) {
            return this.Update(username, name, lastname, dob, password, email, created_at, Original_id, Original_username, Original_name, Original_lastname, Original_dob, Original_created_at, Original_id);
        }
        ...
        public virtual int InsertUser(string username, string name, string lastname, string dob, string password, string email) {
        ...
        public virtual int UpdateUser(string username, string name, string lastname, string dob, string email, int Original_id, int id) {
